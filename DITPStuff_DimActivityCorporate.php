...
if (sqlsrv_num_rows($query_cr2) >0){
    while ($data_loop = sqlsrv_fetch_array($query_cr2, SQLSRV_FETCH_ASSOC)){
        ...
        $DITP_ONE = "INSERT INTO `ditpstuff_dimactivitycorporate`(`CorporateId`, `TaxNo`, `CorporateNameTH`, `ComSize`, `ComSizeBySME`, `ActivityParticipateStatus`, `NewExportStatus`, `ProvinceCode`, `ProvinceName`,
                    `RegionNameTh`, `AddressNoTH`, `DistrictName`, `SubDistrictName`, `Telephone`, `email`, `DBDCapitalValue`, `DBDComSizeCapital`, `DBDObjectDetail`, `DBDJuristicAddress`, `DBDJuristicSubDistrict`, `DBDJuristicDistrict`,
                    ...
                    VALUES ('".$data_loop['CorporateId']."','".$data_loop['TaxNo']."','".$data_loop['CorporateNameTH']."','".$data_loop['ComSize']."','".$data_loop['ComSizeBySME']."','".$data_loop['ActivityParticipateStatus']."','".$data_loop['NewExportStatus']."','".$data_loop['ProvinceCode']."','".$data_loop['ProvinceName']."',
                    '".$data_loop['RegionNameTh']."','".$data_loop['AddressNoTH']."','".str_replace("'S"," S",$data_loop['DistrictName'])."','".$data_loop['SubDistrictName']."','".str_replace("'+66","0",$data_loop['Telephone'])."','".$data_loop['email']."','".$data_loop['DBDCapitalValue']."','".$data_loop['DBDComSizeCapital']."','".$data_loop['DBDObjectDetail']."','".$data_loop['DBDJuristicAddress']."','".$data_loop['DBDJuristicSubDistrict']."','".$data_loop['DBDJuristicDistrict']."',
