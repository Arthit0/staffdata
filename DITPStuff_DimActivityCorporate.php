...
if (sqlsrv_num_rows($query_cr2) >0){
    while ($data_loop = sqlsrv_fetch_array($query_cr2, SQLSRV_FETCH_ASSOC)){
        ...
        $DITP_ONE = "INSERT INTO `ditpstuff_dimactivitycorporate`(`CorporateId`, `TaxNo`, `ComSize`, `ComSizeBySME`, `ActivityParticipateStatus`, `NewExportStatus`, `ProvinceCode`, `ProvinceName`,
                    ...
                    '".$data_loop['RegionNameTh']."','".str_replace("'S","EUSWAS S",$data_loop['DistrictName'])."','".$data_loop['SubDistrictName']."','".str_replace("'+66","0",$data_loop['Telephone'])."','".$data_loop['email']."','".$data_loop['DBDCapitalValue']."','".$data_loop['DBDComSizeCapital']."','".$data_loop['DBDObjectDetail']."','".$data_loop['DBDJuristicAddress']."','".$data_loop['DBDJuristicSubDistrict']."','".$data_loop['DBDJuristicDistrict']."',
