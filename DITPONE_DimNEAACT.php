...
if (sqlsrv_num_rows($query_cr2) >0){
    while ($data_loop = sqlsrv_fetch_array($query_cr2, SQLSRV_FETCH_ASSOC)){
        ...
        '".mysql_escape($data_loop['StartRegisDateDay'],'Y-m-d H:i:s')."','".mysql_escape($data_loop['StartRegisDateMonth'])."','".mysql_escape($data_loop['StartRegisDateQUARTER'])."','".mysql_escape($data_loop['StartRegisDateYear'])."','".mysql_escape($data_loop['StartRegisDateFYear'])."',
        '".date_format($data_loop['Activity_Start_Date'])."','".mysql_escape($data_loop['StartDateDay'])."','".mysql_escape($data_loop['StartDateMonth'])."','".mysql_escape($data_loop['StartDateQUARTER'])."','".mysql_escape($data_loop['StartDateYear'])."',
